   ...
   <>
    ...
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-between py-4">
        <div>
          <img src="/img/sklogo.png" alt="logo"  className="h-16 w-auto mx-auto my-4 rounded-full shadow-lg" />
        </div>

        <div className="hidden sm:flex sm:items-center">
          <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-500 mr-4">Products</a>
          <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-500 mr-4">Marketplace</a>
          <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-500 mr-4">Partners</a>
          <a href="#" className="text-gray-800 text-sm font-semibold hover:text-green-500 ">Pricing</a>
        </div>

        <div className="hidden sm:flex sm:items-center">
          <Link to="/login" className="text-gray-800 text-sm font-semibold hover:text-green-500 mr-4">Sign in</Link>
          <Link to="/register" className="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-green-500 hover:border-green-500">Sign up</Link>
        </div>
