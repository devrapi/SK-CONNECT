...
const Main = () => {
  return (
   <>
        <div className="w-full m-0 font-sans ">
    ...
    <div className="container px-4 mx-auto">
      <div className="flex items-center justify-between py-4">
        ...
        <div className="hidden sm:flex sm:items-center">
          <Link to="/" className="mr-4 font-sans font-normal text-gray-800 text-md hover:text-green-500">Home</Link>
          <a href="#" className="mr-4 font-sans font-normal text-gray-800 text-md hover:text-green-500">Sk Officials</a>
          <a href="#" className="mr-4 font-sans font-normal text-gray-800 text-md hover:text-green-500">About</a>
          <a href="#" className="mr-4 font-sans font-normal text-gray-800 text-md hover:text-green-500">Blog</a>
        </div>

        <div className="hidden sm:flex sm:items-center">
          <Link to="/login" className="mr-4 text-sm font-semibold text-gray-800 hover:text-green-500">Sign in</Link>
          <Link to="/register" className="px-4 py-2 text-sm font-semibold text-white bg-green-500 border rounded-lg hover:bg-green-400">Sign up</Link>
        </div>
